...
echo CHtml::beginForm(Yii::app()->homeUrl.'?r=admin/add','post',array('enctype'=>'multipart/form-data','name'=>'ItemForm'));
...
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][0][min]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][0][max]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][0][customer]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][0][industrial]','');
echo "</td>";
echo "<td>";
...
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][1][min]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][1][max]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][1][customer]','');
echo "</td>";
echo "<td>";
echo CHtml::textField('ItemForm[Policy][0][ItemPrice][1][industrial]','');
echo "</td>";
echo "<td>";
...
echo "<textarea id='notIncludeEditor' name='ItemForm[Policy][0][ItemSection][1][value]'>hundan</textarea>";
echo "</div>";
echo "</fieldset>";//Policy fieldset
echo "</div>"; //policy container box
echo CHtml::button('Add Policy',array('id'=>'addPolicy','class'=>'btn btn-big btn-primary'));
...
echo CHtml::submitButton('提 交',array('class'=>'btn btn-primary btn-big'));
echo CHtml::endForm();

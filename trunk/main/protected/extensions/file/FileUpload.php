 ...
 */
	class FileUpload{	
		private $allowtype = array(); //限制上传文件的类型,可以使用set()设置，使用小字母
		private $maxsize = 100000000;  //限制文件上传大小，单位是字节,可以使用set()设置
		private $israndname = false;   //设置是否随机重命名 false为不随机,可以使用set()设置

...
<h1>#<?php echo $model->id.":".$model->visa->country->name."-".$model->visa->type->name."-".$model->company_name."[".$model->contact_name."]"."-".$model->amount."人" ?></h1>
        ...
        <tr>
            ...
            <td>
                ...
                if(in_array('admin', explode(',', Yii::app()->user->role))){
                    echo $form->radioButtonList($model, 'is_pay', array('1'=>'已支付', '0'=>'未支付'));
                }else{
            ...
            <td>
                <?php
                    ...
                    echo $form->fileField($model, 'pay_file');

...
$this->widget('ext.kindeditor.KindEditorWidget',array(
    'id'=>CHtml::activeId($model, 'material'),   //Textarea id
    ...
    'items' => array(
        ...
        'items'=>array(
            'plainpaste', 'wordpaste', 'clearhtml', '|', 'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic',
...
<tr>
    ...
    <td><label>排序（数字越小排序越靠前）：</label></td>
    <td>
        <?php echo $form->textField($model, 'show_order'); ?>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="5">
        <?php echo $form->textArea($model, 'material', array('visibility'=>'hidden')) ?>

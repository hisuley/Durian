 ...
 * @copyright
 **/
class YutongType extends CActiveRecord{
    ...
    public function rules(){
        return array(
            array('name, notes, country_id, predict_date, price,source_id, is_enabled', 'safe')
        );
    }
    public function relations(){
        return array(
            'goods'=>array(self::HAS_MANY, 'YutongVisaGoods', 'type_id'),
            'source'=>array(self::BELONGS_TO, 'OrderSource', 'source_id')
        );
    }
    /**

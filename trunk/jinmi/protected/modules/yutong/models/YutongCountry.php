...
class YutongCountry extends CActiveRecord{
    ...
    public function relations(){
        return array(
            ...
            'parent'=>array(self::BELONGS_TO, 'YutongCountry', 'parent_id'),
            'related_article'=>array(self::HAS_MANY, 'YutongArticle', 'related_country_id')
        );
    }
    /**
    ...
    public static function findContinent($id){

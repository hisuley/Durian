...
class PHPWord_Section_Table {
	...
	*/
	...
	public function addCell($width, $style = null, $gridSpan = 1, $vMerge = 1) {
		...
		$cell = new PHPWord_Section_Table_Cell($this->_insideOf, $this->_pCount, $width, $style,$gridSpan, $vMerge);

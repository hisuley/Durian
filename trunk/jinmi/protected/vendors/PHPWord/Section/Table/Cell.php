...
class PHPWord_Section_Table_Cell {
	...
	public function __construct($insideOf, $pCount, $width = null, $style = null,$gridSpan =1,$vMerge = 1) {
		$this->_insideOf = $insideOf;
		$this->_pCount = $pCount;
		$this->_width = $width;
		//单元格设置
		$this->_gridSpan = $gridSpan;//for the colspan
		$this->_vMerge = null;//for the rowspan

...
abstract class TbInput extends CInputWidget
{
	...
	{
        if ($this->label === null && !in_array($this->type, array('checkbox', 'radio')) && $this->hasModel())
            return $this->form->labelEx($this->model, $this->attribute, $this->labelOptions);
        else if ($this->label !== null)
            return $this->form->labelEx($this->model, $this->attribute, array_merge(array('label'=>$this->label), $this->labelOptions));
        else
            return '';
	}

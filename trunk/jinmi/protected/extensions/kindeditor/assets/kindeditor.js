...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	...
	arr.push('</head><body style="font-family:宋体" ' + (bodyClass ? 'class="' + bodyClass + '"' : '') + '></body></html>');
	return arr.join('\n');
}
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.iframe = K('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css({'width':'100%', 'fontFamily':"宋体"});
